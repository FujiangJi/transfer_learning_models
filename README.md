...
```
## Credits
* The datasets used in this study were subsets of the compiled dataset from previous study **_(Ji et al, New Phytologist, 2024)_**, and the original data was from the EcoSIS Spectral Library, available at https://ecosis.org/.
